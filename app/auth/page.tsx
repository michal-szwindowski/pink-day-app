...
export default function AuthPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-6xl items-center px-4 py-8 lg:px-8">
      <div className="grid w-full gap-6 lg:grid-cols-[minmax(0,1fr)_28rem] lg:items-center">
        <section className="hidden space-y-5 lg:block">
          ...
          <h1 className="max-w-xl text-5xl font-black leading-tight text-[#422c36]">
            Prywatna aplikacja dla Waszej codzienności.
          </h1>
          <p className="max-w-lg text-base leading-7 text-[#7f6870]">
            Zadania, zdjęcia, punkty i nagrody w lekkim rytmie, bez ciężkiego dashboardu i bez
            publicznego zgiełku.
          </p>
        </section>

        <Card className="overflow-hidden bg-[linear-gradient(180deg,#fffdfd,#fff3f8)] lg:p-7">
          <div className="space-y-5">
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-sm leading-6 text-[#7f6870]">
                Prywatna, prosta aplikacja tylko dla Was. Zaloguj się swoim kontem Google, żeby
                wejść do odpowiedniego widoku.
              </p>
            </div>
            ...
            {status === 'no_access' ? (
              ...
              <div className="space-y-4 rounded-[28px] bg-white/85 p-4">
                <div className="flex items-start gap-3 rounded-3xl bg-[#fff4f6] p-4 text-sm text-[#994761]">
                  <ShieldAlert className="mt-0.5 shrink-0" size={18} />
                  <div>
                    <p className="font-semibold text-[#7f334e]">
                      Logowanie działa, ale profil nie.
                    </p>
                    <p className="mt-1">
                      {lastError ??
              ...
              <div className="space-y-4 rounded-[28px] bg-white/85 p-4">
                ...
                {error ? (
                  <p className="rounded-2xl bg-[#ffe7ee] px-4 py-3 text-sm text-[#ab4661]">
                    {error}
                  </p>
                ) : null}
